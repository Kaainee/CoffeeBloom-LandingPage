      ...
      <Container>
        ...
        <Row>
          <Col md={5} className="mb-4">
            ...
            <div className="d-flex align-items-center mb-3"><FaEnvelope size={18} className="me-4" style={{color: 'var(--color-sun-primary)'}} /><span>CoffeeBloom@gmail.com</span></div>
            <div className="d-flex align-items-center mb-3"><FaPhone size={18} className="me-4" style={{color: 'var(--color-sun-primary)'}} /><span>+62 851-5661-3591</span></div>
          </Col>
          <Col md={7}>
            <h3>Kirim Pesan</h3>
            <Form>
              ...
              <Form.Group className="mb-3" controlId="formGroupEmail"><Form.Label>Nomor Telepon</Form.Label><Form.Control type="email" placeholder="Masukkan Nomor Telepon" /></Form.Group>
