              ...
              <Card className="content-card text-center p-4">
                ...
                <Card.Body>
                  ...
                  <Card.Text>
                    ...
                    pagi, kami sadar pentingnya sarapan yang nggak cuma
                    ngenyangin tapi juga bikin semangat balik lagi. Dari situlah
                    CoffeeBloom lahir. tempat di mana aroma roti hangat jadi
                    teman setia sebelum, sesudah, atau bahkan di tengah-tengah
              ...
              <Card className="content-card text-start p-4">
                ...
                <Card.Body>
                  ...
                  <Card.Text>
                    ...
                    <br></br>
                    <br></br>
                    3. Menyediakan produk roti yang beragam untuk memenuhi
