      ...
      <header id="home" className="hero-image-background">
        <Container className="hero-content text-center">
          ...
          <p className="text-white lead fs-4">
            "Setiap roti kami dibuat dengan cinta, kehangatan, dan bahan
            terbaik. Dari adonan pertama hingga panggangan terakhir, kami
            percaya bahwa rasa bahagia dimulai dari gigitan pertama."
          </p>
        </Container>
      </header>
    </motion.div>
